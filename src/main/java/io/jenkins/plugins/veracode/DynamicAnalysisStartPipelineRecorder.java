...
public class DynamicAnalysisStartPipelineRecorder extends Recorder implements SimpleBuildStep {
	...
	public DynamicAnalysisStartPipelineRecorder(final String analysisName, final int maximumDuration,
			final boolean failBuildAsScanFailed, final String vid, final String vkey, final boolean debug,
			final boolean useProxy, final String pHost, final String pPort, final String pUser,
	...
	public void perform(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener)
		...
		boolean buildSuccess = daAdapterService.resubmitDynamicAnalysis(run, workspace, listener, analysisName,
				maximumDuration, failBuildAsScanFailed, vid, vkey, debug, proxyBlock);
